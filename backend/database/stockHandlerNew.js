...
const getOneHistoricValueYahoo = async (ticker, date) => {
...
const getAllHistoricValueYahoo = async (ticker, from, to) => {
...
const getCurrentValueNew = async (ticker, country, includeTime) => {
...
const insertStockYahoo = async (ticker, country) => {
...
const insertHistoryYahoo = async (ticker, country) => {
